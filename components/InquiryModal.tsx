    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="bg-white rounded-t-3xl md:rounded-2xl w-full md:max-w-lg overflow-hidden shadow-soft-lg"
              onClick={(e) => e.stopPropagation()}
            >
              {!submitted ? (
                <>
                  {/* Header */}
                  <div className="bg-gradient-to-r from-charcoal-800 to-charcoal-700 px-6 py-5">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-charcoal-400 text-xs font-mono mt-0.5">
                          {product.code}
                        </p>
                      </div>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-xl bg-charcoal-700 hover:bg-charcoal-600 text-charcoal-300 transition-colors shrink-0"
                      >
                        <X size={18} />
                      </button>
                    </div>
                ...
                <div className="p-10 flex flex-col items-center text-center">
                  ...
                  <h3 className="font-heading font-bold text-charcoal-800 text-xl mb-2">
                    Talebiniz Alındı!
                  </h3>
                  <p className="text-charcoal-500 text-sm leading-relaxed mb-6">
                    <span className="font-semibold text-charcoal-700">{product.name}</span>{" "}
